...
cfg = EasyDict()
mtcnn_dir='/home/csse/DATASETS/DataSets/mtcnn-head-detection-master/'
# data directories
cfg.Data_DIR = '/home/csse/DATASETS/DataSets/mtcnn-head-detection-master/Ara2013-Canon/'

cfg.CelebA_DIR = 'Ara2013-Canon/'
cfg.WIDER_DIR = 'Ara2013-Canon/'
cfg.FDDB_DIR = 'Ara2013-Canon/'
...
cfg.PROPOSAL_NETS = {
  'p': None,
  'r': [mtcnn_dir+'proto/p.prototxt', mtcnn_dir+'tmp/pnet_iter_446000.caffemodel'],
  'o': [mtcnn_dir+'proto/p.prototxt', mtcnn_dir+'tmp/pnet_iter_446000.caffemodel', mtcnn_dir+'proto/r.prototxt', mtcnn_dir+'tmp/rnet_iter_116000.caffemodel'],
}
cfg.DETECT_PARAMS = {
  'min_size': 24,
  'ths': [0.5, 0.5, 0.5],
